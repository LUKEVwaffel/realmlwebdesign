# Web Design Business Platform

## Overview

A full-stack web application for a web design business consisting of three main parts:
1. **Public Portfolio Website** - Showcases work and builds credibility for potential clients
2. **Client Portal** - Allows invited clients to manage their projects, view payments, documents, and communicate with the team
3. **Admin Dashboard** - Enables business owners to manage all clients, projects, and business analytics
